...
struct EliminateNopAddZero final : public PredicateBasedPass {
  explicit EliminateNopAddZero()
      : PredicateBasedPass(PassType::Nop, PassEfficiency::Complete,
                           PassOptimizationType::Compute) {}

  std::string getPassName() const override {
    return "eliminate_nop_add_zero";
  }
...
#undef CASE_BRANCH_CONTENT
  ...
  bool runTransform(Node* node, Graph& graph,
    ...
    if (isConstantTensor(graph, a_name) && isTensorOfZero(*a_tensor)) {
      replacing_success =
